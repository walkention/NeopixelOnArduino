...
#define PIXELS 400  // Number of pixels in the string
...
void colorWipe(unsigned char r , unsigned char g, unsigned char b, unsigned  char wait, bool empty = false) {
  for(unsigned int i=0; i<=PIXELS; i+=10 ) {
...
void loop() {
  ...
  colorWipe(100, 0, 0, 0); // Red
  colorWipe(0, 100, 0, 0); // Green
  colorWipe(0, 0, 100, 0); // Blue
  colorWipe(100, 0, 0, 0); // Red
  colorWipe(0, 100, 0, 0); // Green
  colorWipe(0, 0, 100, 0); // Blue
  colorWipe(100, 0, 0, 0); // Red
  ...
  colorWipe(0, 100, 0, 0); // Green
  colorWipe(0, 0, 100, 0); // Blue
  //colorWipe(0, 255, 100, 0); // 
  
  // Send a theater pixel chase in...
  theaterChase(0, 127, 0, 0); // Red
  theaterChase(0, 127, 0, 0); // Red
  theaterChase(127,   0,   0, 0); // Green
  theaterChase(127,   0,   0, 0); // Green
  theaterChase(  0,   0, 127, 0); // Blue
  theaterChase(  0,   0, 127, 0); // Blue
  rainbowCycle(1000 , 10 , 5);
